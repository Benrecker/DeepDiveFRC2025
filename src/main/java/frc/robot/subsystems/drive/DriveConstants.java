...
public class DriveConstants {
  public static final double maxSpeedMetersPerSec = 7.632;
  ...
  public static final boolean frontLeftDriveCanIdInverted = true;
  public static final boolean backLeftDriveCanIdInverted = true;
  public static final boolean frontRightDriveCanIdInverted = true;
  public static final boolean backRightDriveCanIdInverted = true;
  ...
  public static final boolean frontLeftTurnCanIdInverted = true;
  public static final boolean backLeftTurnCanIdInverted = true;
  public static final boolean frontRightTurnCanIdInverted = true;
  public static final boolean backRightTurnCanIdInverted = true;
  ...
  public static final double driveMotorReduction = 4.73 / 1.0; // SDS Mk4i L2
