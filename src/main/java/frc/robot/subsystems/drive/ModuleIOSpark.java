...
public class ModuleIOSpark implements ModuleIO {
  ...
  // Hardware objects
  private final SparkFlex driveFlex;
  ...
  public ModuleIOSpark(int module) {
    ...
    turnSpark =
        new SparkMax(
            ...
            MotorType.kBrushless);
    driveEncoder = driveFlex.getEncoder();
    ...
    driveController = driveFlex.getClosedLoopController();
    ...
    tryUntilOk(driveFlex, 5, () -> driveEncoder.setPosition(0.0));
    ...
    drivePositionQueue =
        SparkOdometryThread.getInstance().registerSignal(driveFlex, driveEncoder::getPosition);
    turnPositionQueue =
  ...
  public void updateInputs(ModuleIOInputs inputs) {
    ...
    ifOk(driveFlex, driveEncoder::getPosition, (value) -> inputs.drivePositionRad = value);
    ifOk(driveFlex, driveEncoder::getVelocity, (value) -> inputs.driveVelocityRadPerSec = value);
    ifOk(
        driveFlex,
        new DoubleSupplier[] {driveFlex::getAppliedOutput, driveFlex::getBusVoltage},
        (values) -> inputs.driveAppliedVolts = values[0] * values[1]);
    ifOk(driveFlex, driveFlex::getOutputCurrent, (value) -> inputs.driveCurrentAmps = value);
